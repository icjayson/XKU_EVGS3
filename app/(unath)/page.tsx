...
export default function Home() {
  return (
    <div className="flex flex-col items-center w-full bg-transparent" style={{ background: 'transparent' }}>
      {/* Hero Section */}
      ...
      <section className="w-full pb-8 py-0 flex flex-col items-center">
      ...
      <section className="w-full px-0 py-8">
         <ScrollFloat
          ...
          stagger={0.03}
          containerClassName="text-[72px] text-center mb-12 font-bold !font-appleberry max-md:text-[36px]"
          textClassName="text-[72px] font-bold !font-appleberry max-md:text-[36px]"
        >
          Xưởng Ký Ức có gì?
        </ScrollFloat>
      ...
      <section className="w-full max-w-[1300px] px-12 py-8 max-md:px-4 max-lg:px-40">
        <ScrollFloat
          ...
          scrollEnd='bottom bottom-=40%'
          stagger={0.03}
          containerClassName="text-[72px] text-center mb-4 font-bold !font-appleberry max-lg:text-[36px]"
          textClassName="text-[72px] font-bold !font-appleberry max-lg:text-[36px]"
        >
